...
- **Effect-TS Ecosystem** - [@effect/cli](https://effect.website/docs/guides/cli-applications), [@effect/platform](https://effect.website/docs/guides/platform), [@effect/opentelemetry](https://effect.website/docs/guides/observability/telemetry)
